...
// let userData = [
//     { userId: "U1001", name: "abc", emailId: "abc@gmail.com", contactNo: 9000000000, password: "1234", bookings: ["B1001", "B1002"], destinations: ["D1011","D1010"] },
//     { userId: "U1002", name: "def", emailId: "def@gmail.com", contactNo: 6234567890, password: "Def@1234", bookings: ["B1003"], destinations: ["D1001"] }
// ]
    ...
    return connection.getUserCollection().then((myCollection) => {
        return myCollection.deleteMany().then(() => {
            // return myCollection.insertMany(userData).then(() => {
                return connection.getHotDealsCollection().then( ( hotDealCollection ) => {
                    return hotDealCollection.deleteMany().then( () => {
                        return hotDealCollection.insertMany( hotDeals ).then( () => {
                            return connection.getDestinationsCollection().then( ( DestinationCollection ) => {
                                return DestinationCollection.deleteMany().then( () => {
                                    return DestinationCollection.insertMany( destinations ).then( ( data ) => {
                                        if( data ) {
